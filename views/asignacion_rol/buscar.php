<?php  include_once __DIR__ . '/header-asignacion-rol.php'; ?>
<h1 class="nombre-pagina">Buscar Personal y su rol(es)</h1>
<p class="descripcion-pagina">Llena el formulario para buscar el registro</p>

<div class="contenedor-sm">
    <?php   include_once __DIR__ . '/../templates/alertas.php'; ?>
    <form class="formulario"    action="/asignacion-roles-buscar" method="POST">
...
<?php  include_once __DIR__ . '/footer-asignacion-rol.php'; ?>
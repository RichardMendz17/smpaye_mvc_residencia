<?php 
    ...
    namespace Model;
    class Actividad_Extraescolar_Detalle_Curso extends ActiveRecord {
    // Base de datos
    protected static $tabla = 'cursos_actividades_extraescolares';
    protected static $columnasDB = ['id','curso_url','nombre_instructor', 'nombre_actividad_extraescolar', 'periodo', 'nombre_Aula'];



    public $id;
    public $nombre_instructor;
    public $nombre_actividad_extraescolar;
    public $periodo;
    public $nombre_Aula;
    public $curso_url;
    ...
    public function __construct()
    {
        ...
        $this->nombre_instructor = isset($args['nombre_instructor']) ? trim($args['nombre_instructor']) : '';
        $this->nombre_actividad_extraescolar = isset($args['nombre_actividad_extraescolar']) ? trim($args['nombre_actividad_extraescolar']) : '';
